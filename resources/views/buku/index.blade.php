    ...
    <main class="container">
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <form action='' method='post'>
                @csrf <!-- printah post yang valid , mencegah 419 -->

                @if(Route::current()->uri == 'buku/{id}')  <!-- method put akan dijalankan jika di url ada proses update -->
                @method('PUT')
                @endif
                <div class="mb-3 row">
        ...
        @if(Route::current()->uri == 'buku') <!-- jika url nya pas berada di /buku maka tampilkan data , jika tidak maka tidak akan ditampilkan -->
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ url('buku/'.$item['id']) }}" method="POST" onsubmit="return confirm('Yakin ingin dihapus ?')" class="d-inline">
                                @csrf
                                @method('DELETE')
